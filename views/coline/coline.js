...
%{
     ...
     "for"                 %{ /*lista3D.push(yytext);*/return 'para'; %}
     "graph_dot"           %{ /*lista3D.push(yytext);*/return 'graph_dot'; %}
     "if"                  %{ /*lista3D.push(yytext);*/return 'si'; %}
     "import"              %{ /*lista3D.push(yytext);*/return 'importar'; %}
     "instanceof"          %{ /*lista3D.push(yytext);*/return 'instanceof'; %}
     "int"                 %{ /*lista3D.push(yytext);*/return 'entero'; %}
     "message"             %{ /*lista3D.push(yytext);*/return 'message'; %}
     "new"                 %{ /*lista3D.push(yytext);*/return 'nuevo'; %}
     "object"              %{ /*lista3D.push(yytext);*/return 'objeto'; %}
     "pow"                 %{ /*lista3D.push(yytext);*/return 'pow'; %}
     "println"             %{ /*lista3D.push(yytext);*/return 'println'; %}
     "private"             %{ /*lista3D.push(yytext);*/return 'privado'; %}
     "protected"           %{ /*lista3D.push(yytext);*/return 'protegido'; %}
     "public"              %{ /*lista3D.push(yytext);*/return 'publico'; %}
     "return"              %{ /*lista3D.push(yytext);*/return 'returno'; %}
     ...
     "while"               %{ /*lista3D.push(yytext);*/return 'mientras'; %}
     ...
     "null"                %{ /*lista3D.push(yytext);*/return 'nulo'; %}
